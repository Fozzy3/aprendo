...
const LESSON_MODEL = APRENDO_MODEL_ID
// Bumped with the provider change: cached lessons carry the model that made
// them, and a row generated by the old one should be regenerated rather than
// served as if this model had written it.
  ...
  handler: async (ctx, args) => {
    ...
    try {
      const { object } = await generateObject({
        model: aprendoModel(LESSON_MODEL),
        schema: textSchema,
